...
var adList = [
  ...
  class AdCollection {
    ...
    console.log(collection.getPage(0, 10, { vendor: "Bores" }));
    console.log(collection.getPage(0, 10, { vendor: "Bores", hashTags: ["furniture"] }));
    ...
    console.log(collection.edit("7", { discount: "15%" }));
    console.log(collection.getAd("7"));

    console.log("Test addAd(): ");
    console.log(collection.addAd({
        id: 12,
        description: "Best price in Minsk",
        createdAt: new Date("2021-06-01T23:00:00"),
        link: "https://www.https://sosedi.by/",
        vendor: "Sosedi",
        hashTags: ["cheaply", "fresh"],
        discount: "40%",
